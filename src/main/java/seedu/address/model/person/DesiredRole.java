 ...
 * Guarantees: immutable; is valid as declared in {@link #isValidDesiredRole(String)} Role(String)}
 */
public class DesiredRole {
    ...
    public static boolean isValidDesiredRole(String test) {
        return test.matches(VALIDATION_REGEX); // Ensure this regex is correctly catching invalid cases.
    }
