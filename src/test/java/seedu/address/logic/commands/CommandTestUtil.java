...
public class CommandTestUtil {
    ...
    public static final String VALID_DESIREDROLE_AMY = "Engineer";
    ...
    public static final String INVALID_DESIREDROLE_DESC = " " + PREFIX_DESIREDROLE; // No value after prefix
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
            ...
            .withAddress(VALID_ADDRESS_AMY).withDesiredRole(VALID_DESIREDROLE_AMY)
